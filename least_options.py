...
def create_heatmap(data):
    ...
    plt.title('Valid Transfer Paths to UCs (1=All courses articulated, 0=Some courses not articulated)')
    ...
    plt.tight_layout()
    plt.savefig('transfer_availability_heatmap.png')
    plt.close()
